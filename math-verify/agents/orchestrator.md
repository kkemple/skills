...
Write the completion report to `papers/logs/` following the instructions in `references/log-format.md`. This is a permanent record — the full completion report, unsummarized. Do this before the gotcha review.
