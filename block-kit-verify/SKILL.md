---
name: block-kit-verify
description: "Verify Slack Block Kit JSON using orchestrated multi-role adherence-coherence convergence. Use this skill when the user wants to validate Block Kit layouts, check block structure, verify element compatibility, audit surface restrictions, or ensure Block Kit JSON follows Slack's design guidelines. Trigger on phrases like 'verify the blocks', 'check my Block Kit', 'validate this layout', 'is this Block Kit correct', 'review my Slack message blocks', or when Block Kit JSON has been generated and needs validation before use."
---

# Block Kit Verification
