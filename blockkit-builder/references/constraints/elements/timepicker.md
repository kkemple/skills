...
### [Element:Time Picker]C10: Placeholder indicates context
Placeholder text should hint at what the time represents (e.g., "Meeting start time", "Reminder time"), not use generic phrasing like "Select a time" or "HH:mm".
**Confidence signals:** Generic placeholder like "Pick a time" or a raw format string = high issue confidence. Context-specific placeholder describing what the time is for = low issue confidence.
