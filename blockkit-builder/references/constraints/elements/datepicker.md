...
### [Element:Date Picker]C10: Placeholder indicates expected context
Placeholder text should hint at the date's purpose or context (e.g., "Select a due date", "Choose a start date"), not use generic text like "Pick a date" or "YYYY-MM-DD".
**Confidence signals:** Generic placeholder like "Select a date" or raw format strings = high issue confidence. Context-specific placeholder describing what the date represents = low issue confidence.
