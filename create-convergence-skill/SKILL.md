...
This skill creates a new orchestrated role-based validity-fitness enforcement skill — a self-correcting system where four independent agents (validator, orchestrator, fixer, optimizer) iteratively validate and improve an artifact until it satisfies both structural constraints and fitness for its audience.
